 ...
 * @return
 */
public class Generator_jmeter {
    public static void main(String[] args) {
            generate("E:\\generator","t_students");
    }
    ...
    private static void generate(String model,String ... tableName){
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/jmeter_test?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull");
        ...
        strategy.setSuperEntityClass("com.jmeter.base.BaseEntity");
