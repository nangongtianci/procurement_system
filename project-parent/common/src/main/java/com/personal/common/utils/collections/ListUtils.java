package com.personal.common.utils.collections;
...
public class ListUtils {
	...
	/**
	 * @desc 将字符串拆分成list集合，逗号作为默认分隔符
	 * @param param
	 * @param separator
	 *  e.g("a#b#c|a:b:c.....")
	 * @return
     */
	public static List<String> split(String param,String separator) {

		if(Objects.isNull(param) || param.trim().length() == 0){
			return null;
		}

		List<String> list = Lists.newArrayList(param.split(separator));
		return list;
	 ...
	 * @return
	 */
	public static List<String> split(String param) {

		if(Objects.isNull(param) || param.trim().length() == 0){
			return null;
		}

		List<String> list = Lists.newArrayList(param.split(defaultSeparator));
		return list;
     ...
     * @return
     */
	public static List<Object> randomList(List<Object> list, int count) {
